  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="<?php echo base_url();?>index.php/portal/projects"> <i class="icon-inbox"></i><span class="label label-success">101</span> Projects </a> </li>
        <li class="bg_lo"> <a href="tables.html"> <i class="icon-th"></i> Tasks</a> </li>
